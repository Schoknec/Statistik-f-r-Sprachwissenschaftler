...
1. Wie viele Studenten bekommen zwischen 7 und 9 NP bei einer Standardabweichung von 3?
    ...
    Studenten bekommen zwischen 7 und 9 Notenpunkten.
...
2. Wie viele Studenten bekommen zumindest 10 NP?
    ...
    ` Studenten bekommen zumindest 10 Notenpunkte.


3. Wie viele Studenten bekommen weniger als 10 NP?

    ` 
    pnorm(10,mean=mu,sd=3) * n
    ` Studenten bekommen weniger als 10 Notenpunkte.

4. Wie viele Studenten bekommen weniger als 8 NP?

    `
    pnorm(8,mean=mu,sd=3) * n
    ` Studenten bekommen weniger als 8 Notenpunkte.
...
Um überdurchschnittlich zu sein, muss man mehr als `r 
